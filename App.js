...
export default function App() {
  ...
  async function getAuths() {
    ...
    const grantedBluetoothAdverse = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.BLUETOOTH_ADVERTISE);

    const grantedBluetoothConnect = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.BLUETOOTH_CONNECT);

    const grantedLo = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.ACCESS_COARSE_LOCATION);
    ...
    return (
      ...
      grantedBluetoothAdverse === PermissionsAndroid.RESULTS.GRANTED &&
      grantedBluetoothConnect === PermissionsAndroid.RESULTS.GRANTED &&
      grantedLo === PermissionsAndroid.RESULTS.GRANTED &&
